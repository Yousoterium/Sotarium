...
export function generateFullKeySystemScript(
  ...
  const selectedGameName = targetGame ? targetGame.name : (games[0] ? games[0].name : "San Diego Border Roleplay");
  const selectedGameImage = targetGame ? targetGame.imageUrl : (games[0] ? games[0].imageUrl : "https://raw.githubusercontent.com/Yousoterium/Sotarium/main/images/game1.png");
  ...
  const formattedPayload = unlockedPayload.trim().length > 0 
    ? unlockedPayload.split("\n").map(line => "            " + line).join("\n")
    : `            print("[Sotarium] Script loaded successfully for ${selectedGameName}!")\n            game:GetService("StarterGui"):SetCore("SendNotification", {\n                Title = "Sotarium Hub",\n                Text = "${selectedGameName} unlocked!",\n                Duration = 5\n            })`;

  return `-- Standalone Key System GUI Script (Roblox Luau)
-- Generated by Sotarium Studio | Target: ${selectedGameName}
...
local PrimaryGameThumbId = loadRemoteAsset("thumb_${targetGame ? targetGame.id : 'default'}.png", "${selectedGameImage}", "https://tr.rbxcdn.com/180DAY-a8e7148123010ced8bdce8c0542cc662/768/432/Image/Webp/noFilter")
...
-- Game Thumbnail (Top 2 corners rounded, bottom 2 corners square)
...
GameThumbImage.Image = PrimaryGameThumbId
...
GameTitleLabel.Text = "${selectedGameName}"
...
local function closeSupportedGames()
    ...
    TweenService:Create(TitleBarTopSquareFiller, TweenInfo.new(0.3), {BackgroundTransparency = 1}):Play()
...
SupportedGamesButton.MouseButton1Click:Connect(function()
    ...
    task.spawn(function()
        ...
        fadeOutLoader.Completed:Connect(function()
            ...
            TweenService:Create(TitleBarTopSquareFiller, TweenInfo.new(0.3), {BackgroundTransparency = 0}):Play()
...
-- ===========================================
-- Key Validation Logic (Key: "test" -> Launches Target Game Payload)
-- ===========================================
...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if enteredKey:lower() == "test" then
        ...
        closeTween.Completed:Connect(function()
            ScreenGui:Destroy()
            print("[Key System] Unlocked! Launching script payload for ${selectedGameName}...")
            task.spawn(function()
                -- ===========================================
                -- UNLOCKED SCRIPT PAYLOAD (Executed on Key Success)
                -- ===========================================
${formattedPayload}
            end)
        end)

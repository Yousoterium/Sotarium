...
export function generateFullKeySystemScript(
  ...
  const selectedGameImage = selectedGame.imageUrl;
  ...
  if (unlockedPayload.trim().length > 0) {
...
-- Generated by Sotarium Studio | Target Game: ${selectedGameName}
...
local PrimaryGameThumbId = loadRemoteAsset("thumb_${selectedGame.id}.png", "${selectedGameImage}", "https://tr.rbxcdn.com/180DAY-a8e7148123010ced8bdce8c0542cc662/768/432/Image/Webp/noFilter")
